...
BASE_TRANSMISSION_RATE   = 0.05   # β per contact per tick (summer baseline)
...
INITIAL_EXPOSED_FRACTION = 0.005  # 0.5% start exposed
INITIAL_INFECTED_FRACTION = 0.002 # 0.2% start infectious
